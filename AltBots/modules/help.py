...
HELP_STRING = f"★ 𝐊𝐑𝐈𝐒𝐇𝐍𝐀 𝐡𝐞𝐥𝐩 𝙈𝙚𝙣𝙪 ★\n\n» **ᴄʟɪᴄᴋ ᴏɴ ʙᴇʟᴏᴡ ʙᴜᴛᴛᴏɴꜱ ꜰᴏʀ ʜᴇʟᴘ**\n» **ᴅᴇᴠᴇʟᴏᴘᴇʀ: @Amyyyeeee **"
...
HELP_BUTTON = [
    ...
    [
      Button.url("• ᴄʜᴀɴɴᴇʟ •", "https://t.me/ab_krishna_uff"),
      Button.url("• sᴜᴘᴘᴏʀᴛ •", "https://t.me/High_Society_Chat")
    ]
  ]
    ...
    if event.sender_id in SUDO_USERS:
        try:
          await event.client.send_file(event.chat_id,
              "https://te.legra.ph/file/f4b5a377e988e7ab76172.jpg",
              caption=HELP_STRING,
              buttons=HELP_BUTTON
              )
...
async def helpback(event):
    if event.query.user_id in SUDO_USERS:    
        ...
        await event.answer("Make Your Own KRISHNA Bots !! KRISHNA", cache_time=0, alert=True)
